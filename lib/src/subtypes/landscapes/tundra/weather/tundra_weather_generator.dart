...
class TundraWeatherGenerator extends ListItemGenerator<String> {
  static const _weathers = [
    ...
    'is subject to frequent hailstorms and sleet, which can make travel treacherous',
    ...
    'is subject to sudden and dangerous snowdrifts, which can bury entire settlements and make travel impossible',
    ...
    'is subject to sudden and intense snow squalls, which can reduce visibility to mere meters and make travel nearly impossible',
